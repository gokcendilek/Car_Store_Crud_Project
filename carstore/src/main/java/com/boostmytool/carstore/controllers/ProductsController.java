package com.boostmytool.carstore.controllers;


import com.boostmytool.carstore.models.Product;
import com.boostmytool.carstore.models.ProductDto;
import com.boostmytool.carstore.services.ProductsRepository;
...
product.setImageFileName(storageFileName);
            ...
            product.setBrand(productDto.getBrand());
            product.setModelYear(productDto.getModelYear());
            product.setMileage(product.getMileage());
